...
def get_config_dict():
    classifier_config_dict = {
        ...
        "sklearn.neural_network.MLPClassifier": {
            ...
            "learning_rate_init": [1e-3, 1e-2, 1e-1, 0.5, 1.0],
        },
...
class Classifier:
    ...
    def __init__(
        self, train_input: pd.DataFrame, schema: MulticlassClassificationSchema
    ):
    ...
    def predict_with_model(
        cls, classifier: "Classifier", data: pd.DataFrame, return_proba: bool = False
    ) -> np.ndarray:
        """
        Predict class probabilities for the given data.
        ...
        return (
            classifier.predict_proba(data) if return_proba else classifier.predict(data)
        )
